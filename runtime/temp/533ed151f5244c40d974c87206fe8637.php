<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/think\lists.html";i:1496373782;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="cf">
		...
		<empty name="model.extend">
			<div class="tools">
				<a class="btn" href="<?php echo url('add?model='.$model['id']); ?>">新 增</a>
				<button class="btn ajax-post confirm" target-form="ids" url="<?php echo url('del?model='.$model['id']); ?>">删 除</button>
			</div>
		</empty>
		</div>
		<!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="<?php echo (isset($model['search_key']) && ($model['search_key'] !== '')?$model['search_key']:'title'); ?>" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入关键字">
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo url('Think/lists','model='.$model['name'],false); ?>"><i class="btn-search"></i></a>
			</div>
